...
CLI fallback; they do not change OpenVINO inference. The other VAD settings
control whisper.cpp segment cutting and are unused by the OpenVINO speech gate.
